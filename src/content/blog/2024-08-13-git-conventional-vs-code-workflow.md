...
- [VS Code Conventional Commit Extension](https://code.visualstudio.com/download) - We will install this as part of the blog post.
...
Part one turned out to be really easy! All I needed to do was install the [VS Code Conventional Commit Extension](https://code.visualstudio.com/download)! This easily accessible from the command palette (CTRL+P) by searching for "conventional commit". This takes you the process of providing a good [conventional commit](https://www.conventionalcommits.org/en/v1.0.0/) with prompts and dropdown lists to help you apply all the standard conventions. This is fantastic news for me as my memory is often suspect these days with my whiskey addled mind becoming less and less reliable.
...
![Conventional Commits Autocommit](/assets/2024-08-13-git-conventional-vs-code-workflow/conventional-commit-autocommit.PNG)
...
![Git Smart Commit](/assets/2024-08-13-git-conventional-vs-code-workflow/git-smart-commit.PNG)
...
![Git Post Commit Sync](/assets/2024-08-13-git-conventional-vs-code-workflow/git-post-commit-sync.PNG)
...
![VS Code Auto Save](/assets/2024-08-13-git-conventional-vs-code-workflow/vs-code-auto-save.PNG)

Secondly I changed the keyboard shortcut for the conventional commit to be CTRL+S in my VS code preferences.

![VS Code Keyboard Shortcut](/assets/2024-08-13-git-conventional-vs-code-workflow/vs-code-keyboard-shortcut.PNG)
...
![VS Code Conventional Commit Workflow](/assets/2024-08-13-git-conventional-vs-code-workflow/conventional-commit-workflow.gif)

TODO

If I do decide I have committed to early I can simply press escape to carry on coding. However why would you ever not commit regularly to a remote...? Trunk based development I can imagine would require some [git hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) to protect your commit which is something I might look at soon (see this [pre-commit](https://pre-commit.com/) which looks interesting). For feature branch development however I think this workflow is very handy for good commits, safely remotely stored code and fast feedback!
...
![Conventional Commit History](/assets/2024-08-13-git-conventional-vs-code-workflow/github-conventional-commit-history.PNG)
