...
[UV](https://docs.astral.sh/uv/) is a single tool that will replace all your python package management and virtual environment concerns of the past. Its written in rust and is designed to be fast and efficient. I used to end up with virtual environments all over the shop or my own machine bloated with python versions and libraries I no longer recognised due to my lazy hungover ways. This is no longer the case with [UV](https://docs.astral.sh/uv/)...
...
![UV Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/uv_install.PNG)
...
![UV Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/uv_initiate_package.PNG)
...
![UV Run Package](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/uv_run_package.PNG)
...
Next we're going to convert the package into a CLI. Keeping this simple for the demo we'll leverage the simple greetings package laid out in [packaging python]() - [creating and packaging command-line tools](https://packaging.python.org/en/latest/guides/creating-command-line-tools/), and tweak it to make it slightly simpler. The package will leverage the [typer](https://typer.tiangolo.com/) library which makes creating a CLI tool even easier.
...
We then need to update the `pyproject.toml` file to include an entry point for the script and include a dependency on [typer](https://typer.tiangolo.com/). By adding typer as a dependency UV will automatically install this into our virtual environment for us.
...
![UV Run Package](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/uv_run_cli.PNG)

### Lint the Package

Next up we can lint our python package using [ruff](https://docs.astral.sh/ruff/). This is also brought to us by the same people as UV so is extremely fast and lightweight.
...
![Ruff Check Pass](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/ruff_check_pass.PNG)
...
![Ruff Failure](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/ruff_failure.PNG)
...
![Ruff Fix](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/ruff_failure_fix.PNG)
...
![Ruff Pass](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/ruff_pass.PNG)
...
![Pytest Pass](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/pytest.PNG)
...
Now to simplify both our CI pipeline and our development approach we are going to introduce a [taskfile](https://taskfile.dev/)! Taskfiles are a great way to abstract away common command you want to run and also to keep consistency between your development process and the eventual CI.

### Install Task

You can [install task](https://taskfile.dev/docs/installation) in a number of ways, but here we can just pip install.

```bash
pip install go-task-bin
```

![Taskfile Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_install.PNG)
...
![Taskfile Init](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_init.PNG)
...
![Taskfile Default](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_default.PNG)
...
![Taskfile Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_package_install.PNG)
...
![Taskfile Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_package_install_noforce.PNG)
...
![Taskfile Install](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_package_install_force.PNG)
...
![Taskfile Build](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_build.PNG)
...
![Taskfile Lint](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_lint.PNG)
...
![Taskfile Lint Fix](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_lint_fix.PNG)
...
![Taskfile Test](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_test.PNG)
...
![Taskfile CI](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_ci_noforce.PNG)
...
![Taskfile CI Force](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_ci_force.PNG)
...
![Taskfile List](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/taskfile_list.PNG)
...
There is also a nice [vs code extension for task](https://marketplace.visualstudio.com/items?itemName=task.vscode-task) if you're a GUI monster and you can discover and execute all your tasks from there too.

![Taskfile VS Code Extension](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/task_vscode.PNG)
...
![Taskfile VS Code Extension](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/github_action_success_task.PNG)
...
![Package Demo](/assets/2025-08-15-simplify-python-package-development-with-uv-and-taskfile/package_demo.PNG)
