...
- I'd recommend reading my [previous blog post](/blog/2024-03-31-shift-left-with-scripts) on setting up a basic container app deployment.
...
**The source of this section can be found on freecodecamp [here](https://www.freecodecamp.org/news/how-to-implement-runtime-environment-variables-with-create-react-app-docker-and-nginx-7f9d42a91d70/). I am stealing and summarising below.** Hopefully the latter sections leveraging this solution in deployment absolves me of the stolen material. The best developers steal right?
...
![Local Correct API Console](/assets/2024-04-27-container-react-runtime-variables/console_api_url.png)

and the local website works:

![Local Correct API Web](/assets/2024-04-27-container-react-runtime-variables/web_working_local.png)
...
![Local InCorrect API Console](/assets/2024-04-27-container-react-runtime-variables/console_api_url_bad.png)

and the local website doesn't work:

![Local InCorrect API Web](/assets/2024-04-27-container-react-runtime-variables/web_not_working_local.png)
...
![Docker Compose](/assets/2024-04-27-container-react-runtime-variables/docker_compose.png)
...
As a result of me using the custom web domains, [devwhiskey.hungovercoders.com](https://devwhiskey.hungovercoders.com/) and [whiskey.hungovercoders.com](https://whiskey.hungovercoders.com/), I have had to tell the terraform lifecyle to ignore these changes in the custom domain at the end of the terraform as I could only manage this manually.
...
![Dev Environment](/assets/2024-04-27-container-react-runtime-variables/dev_environment.png)
