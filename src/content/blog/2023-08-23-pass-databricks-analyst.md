...
![Create Workspace](/assets/2023-08-23-pass-databricks-analyst/create-workspace.PNG)
...
5. Set the region to be the same as your databricks workspace and the same as the shortcode you placed for the storage - in this case I used West Europe (euw).
   ![Create Storage](/assets/2023-08-23-pass-databricks-analyst/create-storage.PNG)
6. On the advanced tab ensure that "Enable Hierarchical Namespace" is ticked. This ensures a data lake storage account is created.
   ![Create Storage HNS](/assets/2023-08-23-pass-databricks-analyst/create-storage-hns.PNG)
...
![Create Containers](/assets/2023-08-23-pass-databricks-analyst/create-containers.PNG)
...
6. Click review and create.
   ![Create Databricks Connector](/assets/2023-08-23-pass-databricks-analyst/create-databricks-connector.PNG)
7. Navigate to your storage account, go to Access Control and select + Add.
   ![Storage Add Permissions](/assets/2023-08-23-pass-databricks-analyst/storage-add-permissions.PNG)
...
10. Select review and assign.
    ![Storage Assign Blob Contributor](/assets/2023-08-23-pass-databricks-analyst/storage-assign-blob-contributor.PNG)
...
2. In the top right click your user name and navigate to "Manage Account".
   ...
   ![Manage Account](/assets/2023-08-23-pass-databricks-analyst/manage-account.PNG)

3. Choose data and then select "create metastore".
   ![Create Metastore 01](/assets/2023-08-23-pass-databricks-analyst/create-metastore-01.PNG)
...
7. Set the access connector id to be the external connector resource id you created which will be something like this: /subscriptions/xxxxxx-xxxxxx-xxxxxx-xxxxxx-xxxxxx/resourceGroups/lrn-databricks-rg/providers/Microsoft.Databricks/accessConnectors/lrn-databricks-dbexc-euw-dgrf.
   ...
   ![Create Metastore 02](/assets/2023-08-23-pass-databricks-analyst/create-metastore-02.PNG)

8. Assign the metastore to your new workspace.
   ![Assign Workspace](/assets/2023-08-23-pass-databricks-analyst/assign-workspace.PNG)
...
![Create External Location](/assets/2023-08-23-pass-databricks-analyst/create-external-location.PNG)
...
![Unity Catalog](/assets/2023-08-23-pass-databricks-analyst/unity.drawio.png)
...
![Serverless Warehouse](/assets/2023-08-23-pass-databricks-analyst/sql-areas.PNG)
...
![Serverless Warehouse](/assets/2023-08-23-pass-databricks-analyst/serverless-warehouse.PNG)
...
![Create Folder](/assets/2023-08-23-pass-databricks-analyst/create-folder.PNG)
...
![Create Catalog and Schema](/assets/2023-08-23-pass-databricks-analyst/create-catalog-schema.PNG)

Save the query as "Setup Catalog" in your folder lrn_sql_analyst.

![Save Query](/assets/2023-08-23-pass-databricks-analyst/save-query.PNG)
...
![Data Explorer](/assets/2023-08-23-pass-databricks-analyst/data-explorer.PNG)
...
![Data Explorer](/assets/2023-08-23-pass-databricks-analyst/data-explorer-table.PNG)
...
![Data Explorer](/assets/2023-08-23-pass-databricks-analyst/data-explorer-table-location.PNG)
...
![Create External Schema](/assets/2023-08-23-pass-databricks-analyst/create-external-schema.PNG)
...
![Describe Extended](/assets/2023-08-23-pass-databricks-analyst/describe-extended.PNG)
...
![Describe History](/assets/2023-08-23-pass-databricks-analyst/describe-history.PNG)
...
![Describe History Write](/assets/2023-08-23-pass-databricks-analyst/describe-history-write.PNG)
...
First we need to download some sample data. Download this [file](/assets/2023-08-23-pass-databricks-analyst/data.csv) to your local machine which is a simple csv of locations and what was drank.
...
![New Data](/assets/2023-08-23-pass-databricks-analyst/new-data.PNG)
...
![Import Data Create Table](/assets/2023-08-23-pass-databricks-analyst/import-data-create-table.PNG)
...
![Import Data Advanced](/assets/2023-08-23-pass-databricks-analyst/import-data-advanced.PNG)
...
![Select Night Out](/assets/2023-08-23-pass-databricks-analyst/select-night-out.PNG)
...
![Inner Join](/assets/2023-08-23-pass-databricks-analyst/join-inner.PNG)
...
![Left Join](/assets/2023-08-23-pass-databricks-analyst/join-left.PNG)
...
![Right Join](/assets/2023-08-23-pass-databricks-analyst/join-right.PNG)
...
![Explode Arrays](/assets/2023-08-23-pass-databricks-analyst/arrays-explode.PNG)
...
![Transform Arrays](/assets/2023-08-23-pass-databricks-analyst/arrays-transform.PNG)
...
![Merge](/assets/2023-08-23-pass-databricks-analyst/merge.PNG)
...
![Query History](/assets/2023-08-23-pass-databricks-analyst/query-history.PNG)
...
![Query History Example](/assets/2023-08-23-pass-databricks-analyst/query-history-example.PNG)
...
![Visualisation Add](/assets/2023-08-23-pass-databricks-analyst/visualisation-add.PNG)
...
![Visualisation Counter](/assets/2023-08-23-pass-databricks-analyst/visualisation-counter.PNG)
...
![Visualisation Bar](/assets/2023-08-23-pass-databricks-analyst/visualisation-bar.PNG)
...
![Get Place](/assets/2023-08-23-pass-databricks-analyst/get-place.PNG)
...
![Visualisation Parameters](/assets/2023-08-23-pass-databricks-analyst/visualisation-parameters.PNG)

We can now choose the places we want to query very easily from the dropdown that is populated for us as a parameter.

![Visualisation Parameters Chart](/assets/2023-08-23-pass-databricks-analyst/visualisation-parameters-chart.PNG)

## Dashboard

Navigate to dashboard on the left hand side of the workspace. Click create dashboard and name it "Nights Out".

![Dashboard New](/assets/2023-08-23-pass-databricks-analyst/dashboard-new.PNG)
...
![Dashboard Add Text](/assets/2023-08-23-pass-databricks-analyst/dashboard-add-text.PNG)
...
![Dashboard Add Visualisation 01](/assets/2023-08-23-pass-databricks-analyst/dashboard-add-visualisation-01.PNG)
...
![Dashboard Add Visualisation 02](/assets/2023-08-23-pass-databricks-analyst/dashboard-add-visualisation-02.PNG)
...
![Dashboard Final](/assets/2023-08-23-pass-databricks-analyst/dashboard-final.PNG)
...
![Dashboard Schedule](/assets/2023-08-23-pass-databricks-analyst/dashboard-schedule.PNG)
...
![Alert Save](/assets/2023-08-23-pass-databricks-analyst/alert-save.PNG)
...
![Alert Triggered](/assets/2023-08-23-pass-databricks-analyst/alert-triggered.PNG)
