...
![Github Project](/assets/2024-01-28-github-add-to-project/github_project.png)
...
![Project Link](/assets/2024-01-28-github-add-to-project/project_link.png)
...
![Project Automation](/assets/2024-01-28-github-add-to-project/project_automation.png)
...
![Template Usage](/assets/2024-01-28-github-add-to-project/template_usage.png)
...
The catch-all method of ensuring that any issue raised lands on the board of your choice is to leverage the [add to project github action](https://github.com/actions/add-to-project). The action code can be found in the hungovercoders template [here](https://github.com/hungovercoders/template.github.platform/blob/main/.github/workflows/add-to-project.yml) and can also be seen below.
...
![Github Variables](/assets/2024-01-28-github-add-to-project/github_variables.png)

The PAT token I generated from my own user and placed that as an organisation level secret.

![Github Secrets](/assets/2024-01-28-github-add-to-project/github_secrets.png)
...
![Github Action](/assets/2024-01-28-github-add-to-project/github_action.png)
