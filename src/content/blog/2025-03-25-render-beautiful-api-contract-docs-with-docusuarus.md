...
- [See my previous post on setting up a docusaurus website](/blog/2024-12-02-deploy-docusaurus-on-azure-static-web-apps)
...
If you've setup [Docusaurus](https://docusaurus.io/) like in my [previous post](/blog/2024-12-02-deploy-docusaurus-on-azure-static-web-apps), you should have a root directory layout that looks something like this:
...
Next the fun bit to render these documents beautifully in docusaurus using this awesome [openapi plugin](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs). You can follow the documentation on the plugin page but I'll give you a quick start guide here.
...
To see the latest dependency matrix for the open api docs go [here](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs#compatibility-matrix). As long as your docusaurus version and open api docs version are compatible you should be good to go.

### Configure Docusaurus Config File

This bit tripped me up a few times and luckily I realised I could use the [docusaurus-openapi-template](https://github.com/PaloAltoNetworks/docusaurus-template-openapi-docs/blob/main/docusaurus.config.ts) as a good reference point.
...
![Whiskey MDX Files](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_whiskey_mdx_directory.PNG)
...
![Whiskey Sidebar](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_whiskey_sidebar.PNG)

And the stunning API docs 😍

![Whiskey API Docs](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_whiskey_api.PNG)

## Resolving Issues

If you do get issues with any of the above (which I did on occasion) make sure you try some of the following:

- Revisit the [docusaurus-openapi-template](https://github.com/PaloAltoNetworks/docusaurus-template-openapi-docs/blob/main/docusaurus.config.ts) for reference
- Check the [compatibility matrix](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs#compatibility-matrix) for docusaurus vs the open api docs and ensure they match
- Check out any [open issues](https://github.com/PaloAltoNetworks/docusaurus-openapi-docs/issues) on the docusaurus open api github page
...
![Whiskey Code Docs Standard](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_api_example01.PNG)
...
![Whiskey Code Docs Theme](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_api_example02.PNG)

And of course I utilise the dracula theme for dark mode!

![Whiskey Code Docs Dark Theme](/assets/2025-03-25-render-beautiful-api-contract-docs-with-docusuarus/docusaurus_api_example_dark.PNG)
