...
![VSCode Postman](/assets/2023-12-30-postman-vscode-marvel/vscode_postman.PNG)

You'll also notice postman commands in the command palette (CTRL+SHIFT+P).

![VSCode Palette](/assets/2023-12-30-postman-vscode-marvel/vscode_pallete.PNG)

### Create a Postman Environment

In the postman extension, select environments, click add and call it "Marvel".

![New Environment](/assets/2023-12-30-postman-vscode-marvel/environment_new.PNG)
...
![Environment Keys](/assets/2023-12-30-postman-vscode-marvel/environment_keys.PNG)
...
![Environment Keys](/assets/2023-12-30-postman-vscode-marvel/environment_variables.PNG)

### Create Postman Collection

In the postman extension, select collections, click add and call it "Marvel".

![New Collection](/assets/2023-12-30-postman-vscode-marvel/collection_new.PNG)

Give the collection a description.

![Collection Description](/assets/2023-12-30-postman-vscode-marvel/collection_description.PNG)
...
![Collection Environment](/assets/2023-12-30-postman-vscode-marvel/collection_environment.PNG)
...
![Collection Auth](/assets/2023-12-30-postman-vscode-marvel/collection_auth.PNG)
...
![Collection PreRequest](/assets/2023-12-30-postman-vscode-marvel/collection_pre_request.PNG)
...
![Collection Character Id](/assets/2023-12-30-postman-vscode-marvel/collection_char_id.PNG)
...
![Collection Folder](/assets/2023-12-30-postman-vscode-marvel/collection_folder.PNG)
...
![Request Characters Example 1](/assets/2023-12-30-postman-vscode-marvel/request_characters_ex1.PNG)
...
![Request Auth](/assets/2023-12-30-postman-vscode-marvel/request_auth.PNG)
...
![Request Toggle Console](/assets/2023-12-30-postman-vscode-marvel/request_toggle_console.PNG)

You can then see all the logs and statuses in the Postman console below the request.

![Request Console](/assets/2023-12-30-postman-vscode-marvel/request_console.PNG)
...
![Request Characters Example 2](/assets/2023-12-30-postman-vscode-marvel/request_characters_ex2.PNG)
...
![Request Character](/assets/2023-12-30-postman-vscode-marvel/request_character.PNG)
...
![Request Documentation](/assets/2023-12-30-postman-vscode-marvel/request_documentation.PNG)

You can also view documentation at the collection level.

![Collection Documentation 1](/assets/2023-12-30-postman-vscode-marvel/collection_documentation.PNG)
...
![Collection Documentation 2](/assets/2023-12-30-postman-vscode-marvel/collection_documentation_1.PNG)
...
![Postman Variable Descriptions](/assets/2023-12-30-postman-vscode-marvel/postman_variables.PNG)
...
![Postman Example](/assets/2023-12-30-postman-vscode-marvel/postman_example.PNG)
...
![Postman Tests](/assets/2023-12-30-postman-vscode-marvel/postman_tests.PNG)
...
![VS Code Docs 1](/assets/2023-12-30-postman-vscode-marvel/vscode_docs_1.PNG)

I can also go to the collection documentation and get starter code for my example requests in a range of languages! Sweet.

![VS Code Docs 2](/assets/2023-12-30-postman-vscode-marvel/vscode_docs_2.PNG)
