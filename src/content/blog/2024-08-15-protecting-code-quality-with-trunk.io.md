...
As always I will be using the mighty [gitpod](https://gitpod.io) so I won't need to configure anything other than spinning up a workspace.
...
- **[Flaky Tests](https://trunk.io/flaky-tests)**: This an upcoming project that can detect and remove flaky tests from your pipelines on any CI system. I know a few people who are going to be interested in this!
...
First sign-up to [Trunk](https://trunk.io/) at [app.trunk.io](https://app.trunk.io/). If you're concerned about costs fear not as they offer a [free tier](https://trunk.io/pricing)[Trunk](https://trunk.io/) which is unlimited on public repos and free for up to five committers on private repos (thank you [Trunk](https://trunk.io/)!).

![Trunk Welcome](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_welcome.PNG)

Then select "code quality" and connect the trunk app to your github organisation(s).

![Trunk Connect Github](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_connect_github.PNG)
...
To initialise trunk you first need to install the CLI as per the [docs](https://docs.trunk.io/code-quality/usage) by running the below.
...
I have added this installation to the [gitpod](https://gitpod.io) configuration files of the repos I have added Trunk to so far. I may eventually just create a standard image with this in as I feel so enamoured with it right now.

To [initialise trunk in a repo](https://docs.trunk.io/code-quality/advanced-setup/cli/init-in-a-git-repo) you run:

```bash
trunk init
```

This will create the initial [trunk.yml](https://docs.trunk.io/code-quality/reference/trunk-yaml) file of your repo that controls things like the linters you want to use and what actions you want enabled. The linters installed will be inferred by the code you already have in your repo. The yaml file will look something like the following.
...
![Trunk Init](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_init.PNG)
...
![Trunk Enable](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_enable.PNG)

This was my sandbox and as you can see, ahem, my code quality is not quite up to scratch!

![Trunk Enable](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_enable_check.PNG)

Moving on now to how we will improve our code quality...

## Code Quality

Code quality tends to rely on [code linting](https://owasp.org/www-project-devsecops-guideline/latest/01b-Linting-Code) that highlights where code is not meeting certain standards of readability or security. Its something we rely often manually to be done by other developers when performing pull requests. The amount of [code linters](https://github.com/caramelomartins/awesome-linters) out there suggest this should be automated and this is exactly where trunk comes in.
...
![Trunk Check List](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_check_list.PNG)
...
![Trunk Check](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_check.PNG)
...
![Trunk Check All 1](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_check_all1.PNG)

![Trunk Check All 2](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_check_all2.PNG)
...
![Trunk Format](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_format.PNG)
...
![Trunk Format All](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_format_all.PNG)
...
I want to make sure I don't commit any new poor code quality changes into my repo. I can do this using the built-in actions provided by [Trunk](https://trunk.io/).
...
![Trunk Actions List](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_actions_list.PNG)
...
![Trunk Actions Enable](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_actions_enabled.PNG)
...
![Trunk PreCommit](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_pre_commit.PNG)
...
![Trunk PreCommit](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_pre_commit_check.PNG)
...
Along with [previous post on conventional commit setup](/blog/2024-08-13-git-conventional-vs-code-workflow) my new git workflow straight to main is as follows.
...
Next, to protect myself and others I want to investigate how to perform testing before allowing merging into main, to hopefully safely meet the goal of trunk based development. Those over at [Trunk](https://trunk.io/) have definitely made this journey a lot easier! I highly recommend checking out the [docs](https://docs.trunk.io/) over at [Trunk](https://trunk.io/) as I am just scratching the surface on what is possible.

## Mega Tidy Commit Example

I first installed trunk on my datagriff blog and it is here that I had that first "wow" moment of how powerful trunk could be in doing a big tidy up of my code in the real world. [Here is the link to the commit](https://github.com/hungovercoders-blog/datagriff/commit/cc71393a6d9165a11c34cf2b3f109fb6784e94f6) and also a screenshot below showing how much of the code, and images, it brought up to standard for me. I am highly likely going to be embedding trunk in all my workflows and adding as a standard to my gitpod configuration files. Sweet sweet code protection is just what a gung-ho, lazy and terrified hungovercoder needs!

![Trunk Commit](/assets/2024-08-15-protecting-code-quality-with-trunk.io/trunk_commit.PNG)
