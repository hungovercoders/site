...
![Python File Download](/assets/2023-04-14-local-install-spark/python_download_file.png)
...
![Python Install](/assets/2023-04-14-local-install-spark/python_install.png)

Click install now to complete. Check then in your environment variables to confirm python has been added to your PATH.

![Python Environment Variables](/assets/2023-04-14-local-install-spark/python_download_file.png)

## Java Install

Go to [java downloads](https://www.java.com/en/download/help/windows_manual_download.html) and go to download and install.

![Java Download](/assets/2023-04-14-local-install-spark/java_download.png)

Choose the manual download page. On this page choose windows offline 64-bit.

![Java Manual Download](/assets/2023-04-14-local-install-spark/java_manual_download.png)
...
![Java Environment Variable](/assets/2023-04-14-local-install-spark/java_environment_variables.png)

## Spark Install

Download spark from [here](https://spark.apache.org/downloads.html).

![Spark Download](/assets/2023-04-14-local-install-spark/spark_download.png)
...
![Spark Suggested Download](/assets/2023-04-14-local-install-spark/spark_suggested_download.png)
...
![Spark Copied](/assets/2023-04-14-local-install-spark/spark_copied.png)

Then add SPARK_HOME to your system environment variables with the value C:\Spark.

![Spark System Variables](/assets/2023-04-14-local-install-spark/spark_environment_variable.png)

Finally add a new Path in your system environment variables with the value %SPARK_HOME%\bin.

![Hadoop Path Environment Variable](/assets/2023-04-14-local-install-spark/hadoop_path_environment_variable.png)
...
![Hadoop Download](/assets/2023-04-14-local-install-spark/hadoop_download.png)

Add a C:\Hadoop\bin folder your machine and add the winutils.exe to this.

![Hadoop Copied](/assets/2023-04-14-local-install-spark/hadoop_copied.png)

Then add HADOOP_HOME to your system environment variables with the value C:\Hadoop.

![Hadoop System Variables](/assets/2023-04-14-local-install-spark/hadoop_system_variables.png)
...
![Spark CMD](/assets/2023-04-14-local-install-spark/spark_cmd.png)

You can also navigate to the local host spark UI here [http://localhost:4040/](http://localhost:4040/).

![Spark UI](/assets/2023-04-14-local-install-spark/spark_ui.png)
