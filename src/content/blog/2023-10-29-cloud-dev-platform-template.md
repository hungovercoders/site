...
![Terraform Providers](/assets/2023-10-29-cloud-dev-platform-template/terraform_providers.PNG)
...
![Gartner 2023](/assets/2023-10-29-cloud-dev-platform-template/gartner.PNG)
...
I think as a hungovercoder it is more important that it solves the problem of "that's how I got it to work on my machine!!!" as well as the classic "it runs on my machine...". I have started dabbling with both [github codespaces](https://github.com/features/codespaces) and [gitpod](https://www.gitpod.io/cde) for cloud developer environment experiences and I would recommend you do the same to make the choice that suits you. I started my journey with gitpod, which is why the current blog sticks to this at the moment, but if you check out the [repo](https://github.com/hungovercoders/template.azure.terraform) referenced throughout it will also have the configuration mostly setup for codespaces too. They both leverage a common container setup so its very easy to make your code function for both. I fully expect the repo to keep evolving so keep an eye...
...
![Gitpod Prebuilds](/assets/2023-10-29-cloud-dev-platform-template/gitpod_prebuilds.PNG)
...
![Azure App Reg](/assets/2023-10-29-cloud-dev-platform-template/azure_app_reg.PNG)
...
![Azure Role](/assets/2023-10-29-cloud-dev-platform-template/azure_app_reg_role.PNG)
...
![Gitpod Variables](/assets/2023-10-29-cloud-dev-platform-template/gitpod_variables.PNG)
...
![Azure CLI](/assets/2023-10-29-cloud-dev-platform-template/azure_cli.PNG)
...
![Storage Account](/assets/2023-10-29-cloud-dev-platform-template/storage_account.PNG)
...
![Azure CLI](/assets/2023-10-29-cloud-dev-platform-template/terraform.PNG)
...
![Github Template](/assets/2023-10-29-cloud-dev-platform-template/use_template.PNG)
