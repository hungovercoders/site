...
![Basic FastAPI](/assets/2023-01-02-docker-environment-variables/basic-fastapi.png)
...
![Basic FastAPI Environment Variables](/assets/2023-01-02-docker-environment-variables/basic-fastapi-env-var.png)
...
![Docker Local Environment Variables](/assets/2023-01-02-docker-environment-variables/docker-local-env-var.png)
...
![Docker Hub](/assets/2023-01-02-docker-environment-variables/docker-hub.png)
...
![Azure Variables Not Set](/assets/2023-01-02-docker-environment-variables/azure-var-not-set.png)
...
![Application Settings](/assets/2023-01-02-docker-environment-variables/add-app-settings.png)

Give them any value and remember to save when completed...

![Application Setting](/assets/2023-01-02-docker-environment-variables/add-app-setting.png)
...
![Application Environment Variables](/assets/2023-01-02-docker-environment-variables/app-env-var.png)
...
![System Assigned Identity](/assets/2023-01-02-docker-environment-variables/sa-identity.png)
...
![Key Vault Permissions](/assets/2023-01-02-docker-environment-variables/kv-access-policies.png)
...
![Application Setting Key Vault](/assets/2023-01-02-docker-environment-variables/add-app-setting-kv.png)

Now finally if you go to your WebApp URL you will see the new values from key vault present.

![WebApp Key Vault](/assets/2023-01-02-docker-environment-variables/webapp-keyvault.png)
