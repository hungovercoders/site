...
![Test Fail](/assets/2024-03-31-shift-left-with-scripts/test_fail.png)
...
![Docker Test Fail](/assets/2024-03-31-shift-left-with-scripts/docker_test_fail.png)
...
![Docker Test Succeed](/assets/2024-03-31-shift-left-with-scripts/docker_test_succeed.png)
...
![Docker Hub](/assets/2024-03-31-shift-left-with-scripts/docker_hub.png)
...
![API URL Working](/assets/2024-03-31-shift-left-with-scripts/api_url_working.png)

## Local Infrastructure Development

### Pre Requisites

Before you deploy a container app, you will need to setup an Azure Container Environment and associated Log Analytics. You can see this [hungovercoders repo](https://github.com/hungovercoders/platform.azure) here if you want to use terraform to do this or just create them manually for now.

### Terraform

I covered in great detail in a [previous blog post](/blog/2023-10-29-cloud-dev-platform-template) about how to leverage terraform for local development using cloud development environments. Here I will just highlight the fact I have adjusted the main terraform file to include a container app deploy.
...
![Local Pipeline](/assets/2024-03-31-shift-left-with-scripts/local_pipeline.png)
...
![Github Actions](/assets/2024-03-31-shift-left-with-scripts/github_actions.png)
...
![Github Actions Test](/assets/2024-03-31-shift-left-with-scripts/github_actions_test.png)

### Azure Outcome

Once the pipeline has finished we get an azure container app:

![Github Actions Test](/assets/2024-03-31-shift-left-with-scripts/azure_container_app.png)

That references an image...

![Azure Image Tag](/assets/2024-03-31-shift-left-with-scripts/azure_image_tag.png)

That was the latest commit in our github action...

![Github Action Version](/assets/2024-03-31-shift-left-with-scripts/github_action_version.png)

And the latest one we see in docker hub!

![Docker Hub Version](/assets/2024-03-31-shift-left-with-scripts/docker_hub_version.png)
